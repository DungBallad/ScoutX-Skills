...
- **TUYỆT ĐỐI KHÔNG DÙNG EMOJI**: Không dùng emoji hệ điều hành (🌐, 🧠, 📊, 🎨, ⚡, 💡, 💬...). Bắt buộc dùng bộ Icon UI/UX chuẩn công nghiệp như **Lucide Icons** (hoặc Feather / Heroicons) với SVG nét mảnh (`1.5px – 2px`), hoặc Sơ đồ tương tác (Concentric Circles / Diagrams), Chỉ số thập phân `01, 02...`.
